 ...
 * - RFC 9542（RFC 7042 を置き換えた）§2.1.2（説明用の MAC アドレス 00-00-5E-00-53-00〜FF）、付録 B（EtherType 0x0806 = ARP、0x0800 = IPv4）
...
/** 説明用のアドレス（RFC 5737 / RFC 1918）と MAC アドレス（RFC 9542 §2.1.2）。MAC の最後のバイトは IP の最後の数の 16 進 */
